...
{
    private const TABLES = ['app_meta', 'users', 'rooms', 'room_members', 'messages', 'user_events', 'user_presence', 'typing_indicators', 'audit_logs', 'ephemeral_shares', 'public_feedback'];
